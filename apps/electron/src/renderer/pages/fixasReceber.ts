    ...
    body: `
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <label id="f-account-pix-label" style="display:${isBrazilLocale && isPixEligibleAccountType(accounts.find(a => a.id === receivable?.account_id)?.type ?? '') ? 'flex' : 'none'};align-items:center;gap:4px;font-size:11px;color:var(--text-2);margin-top:6px" title="Recebido via Pix">
